...
const WaterTrackPopup: React.FC<WaterTrackPopupProps> = ({
  ...
  const saveWaterIntake = async () => {
    ...
    fetch("https://fitnessgeekbackend-production.up.railway.app/watertrack/addwaterentry", {
      method: "POST",
      headers: {
  ...
  const getWaterIntake = async () => {
    ...
    fetch("https://fitnessgeekbackend-production.up.railway.app/watertrack/getwaterbydate", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteWaterIntake = async (item: any) => {
    ...
    fetch(
      "https://fitnessgeekbackend-production.up.railway.app/watertrack/deletewaterentry",
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
