...
const SleepTrackPopup: React.FC<SleepTrackPopupProps> = ({
  ...
  const saveSleepIntake = async () => {
    ...
    fetch("https://fitnessgeekbackend-production.up.railway.app/sleeptrack/addsleepentry", {
      method: "POST",
      headers: {
  ...
  const getSleepIntake = async () => {
    ...
    fetch("https://fitnessgeekbackend-production.up.railway.app/sleeptrack/getsleepbydate", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteSleepIntake = async (item: any) => {
    ...
    fetch(
      "https://fitnessgeekbackend-production.up.railway.app/sleeptrack/deletesleepentry",
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
