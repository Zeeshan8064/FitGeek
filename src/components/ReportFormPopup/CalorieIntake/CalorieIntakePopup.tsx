...
const CalorieIntakePopup: React.FC<CaloriIntakePopupProps> = ({ setShowCalorieIntakePopup }) => {
  ...
  const saveCalorieIntake = async () => {
    ...
    fetch('https://fitnessgeekbackend-production.up.railway.app/calorieintake/addcalorieintake',{
      method: 'POST',
      headers: {
  ...
  const getCalorieIntake = async ()  => {
    setItems([])
    fetch('https://fitnessgeekbackend-production.up.railway.app/calorieintake/getcalorieintakebydate',{
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const deleteCalorieIntake = async (item: any) => {
    fetch('https://fitnessgeekbackend-production.up.railway.app/calorieintake/deletecalorieintake',{
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
      },
