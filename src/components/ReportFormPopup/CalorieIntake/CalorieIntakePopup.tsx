  ...
  return (
    <div className='popupout'>
      ...
      <div className='popupbox'>
        ...
        <TextField id="filled-basic" label="Food item name" variant="filled" color="warning" />
        <TextField id="filled-basic" label="Food item amount (in gms)" variant="filled" color="warning" />
